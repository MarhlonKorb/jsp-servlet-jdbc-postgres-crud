        ...
        <body>
            ...
            <header>
                <nav class="navbar navbar-expand-md navbar-dark" style="background-color: tomato">
                    <div>
                        <a href="http://localhost:8080/jsp-servlet-jdbc-postgres-crud/user-form.jsp" class="navbar-brand"> User Management App </a>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <fieldset class="form-group">
                            <label>Nome do usuário</label> <input type="text" value="<c:out value='${user.name}' />" class="form-control" name="name" required="required">
                        </fieldset>
